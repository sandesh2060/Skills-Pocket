// ============================================
// FILE: frontend/user/src/components/common/Footer.jsx
// ============================================
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-bold text-white">SkillsPocket</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/how-to-hire" className="hover:text-primary transition-colors">How to Hire</Link></li>
              <li><Link to="/talent-marketplace" className="hover:text-primary transition-colors">Talent Marketplace</Link></li>
              <li><Link to="/project-catalog" className="hover:text-primary transition-colors">Project Catalog</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/how-to-find-work" className="hover:text-primary transition-colors">How to Find Work</Link></li>
              <li><Link to="/direct-contracts" className="hover:text-primary transition-colors">Direct Contracts</Link></li>
              <li><Link to="/find-freelance-jobs" className="hover:text-primary transition-colors">Find Jobs</Link></li>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-400">
            © {currentYear} SkillsPocket. All rights reserved.
          </p>
