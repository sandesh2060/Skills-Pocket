...
import { getRedirectPath, isAdminEmail } from '../utils/authUtils';
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        const redirectPath = getRedirectPath(userType, userData.role);
  ...
  return (
    <div className="flex min-h-screen bg-bg-light">
      {/* Left Side - Background Image with Quote (Hidden on Mobile) */}
      <div 
      ...
      >
        ...
        <div className="absolute top-12 left-12 flex items-center gap-3">
          ...
          <span className="text-white text-2xl font-extrabold tracking-tight">SkillsProcket</span>
        </div>
        ...
        <div className="relative z-10 max-w-xl">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-lg font-medium opacity-90 tracking-wide uppercase">Professional Excellence</p>
            </div>
          </div>
          ...
          <div className="mt-12 flex items-center gap-6 text-white/80">
            <div className="flex -space-x-3">
              ...
              />
              <div className="w-10 h-10 rounded-full bg-primary border-2 border-white/20 flex items-center justify-center text-[10px] font-bold">
                +2k
              </div>
            </div>
        ...
        <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 md:px-24 py-16">
          <div className="max-w-[440px] w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-primary transition-colors" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-12 pr-4 py-4 rounded-xl border border-slate-200 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full pl-12 pr-12 py-4 rounded-xl border border-slate-200 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-primary text-white py-4 rounded-xl font-bold text-lg hover:bg-primary/90 shadow-xl shadow-primary/20 transition-all transform active:scale-[0.99] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-3 py-3.5 px-4 border border-slate-200 rounded-xl hover:bg-slate-50 transition-all font-bold text-sm text-slate-700">
            ...
            {/* Footer Links */}
            <div className="mt-16 pt-8 border-t border-slate-100 flex justify-center gap-8 text-[11px] text-slate-400 font-bold uppercase tracking-widest">
