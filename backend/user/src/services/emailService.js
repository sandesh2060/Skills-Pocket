  ...
  emailVerification: (data) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #137fec;">Welcome to SkillsProcket!</h2>
        <p>Hi ${data.name},</p>
        ...
        <p style="color: #666; font-size: 12px;">SkillsProcket - Premium Freelancing Marketplace</p>
      </div>
    `,
  }),
...
exports.sendEmail = async ({ to, template, data }) => {
  try {
    ...
    const mailOptions = {
      from: `"SkillsProcket" <${process.env.EMAIL_FROM || 'noreply@skillsprocket.com'}>`,
      to,
...
console.log('📧 Email Service loaded in MOCK mode - emails will be logged to console');