...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (response.success) {
      // CORRECT: Backend returns { success, data: { user, token } }
      const token = response.data.token;  // ✅ token is inside data
      const userData = response.data.user; // ✅ user is inside data
      const userType = response.userType;  // ✅ This comes from authApi.js
